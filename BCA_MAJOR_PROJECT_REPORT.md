...
ProgLearn CMS is designed to solve both needs in one integrated solution:
...
1. **Homepage Hero Section** (`/`)
   - **Caption:** “Homepage showing ProgLearn hero section and primary call-to-action.”
