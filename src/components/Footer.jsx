  ...
  return (
    <footer className="mt-16 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
      <div className="mx-auto grid max-w-7xl gap-6 px-4 py-10 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div>
          <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">Codev - Created by <DevKumarLink /></h2>
          ...
          <p className="mt-3 text-xs text-slate-500 dark:text-slate-400">© 2026 <DevKumarLink />. All rights reserved.</p>
        </div>
