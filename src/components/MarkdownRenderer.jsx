  ...
  return (
    <div className="group relative mx-2 my-5 overflow-hidden rounded-xl border border-slate-700 bg-slate-900 shadow-sm sm:mx-3">
      ...
      <div className="relative">
        <span className="pointer-events-none absolute inset-y-0 left-0 w-1.5 bg-indigo-400/70" aria-hidden="true" />
        <pre className="overflow-x-auto py-5 pl-14 pr-7 text-left text-sm leading-7">
          <code
