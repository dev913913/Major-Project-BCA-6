...
function CodeBlock({ className, children }) {
  ...
  return (
    <div className="group relative mx-auto my-5 w-[96%] overflow-hidden rounded-xl border border-slate-700 bg-slate-900 shadow-sm">
      ...
      <pre className="overflow-x-auto px-7 py-5 text-left text-sm leading-7">
        <code
          className={`language-${language} block min-w-max whitespace-pre`}
